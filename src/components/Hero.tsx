  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-16 sm:pt-20 sm:pb-0 overflow-hidden" style={{ backgroundColor: '#232222' }}>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8">
        <div className="flex justify-center items-end sm:justify-end sm:items-end h-[80vh]">
          <div className="max-w-xl pr-0 sm:pr-8 pb-12 sm:pb-16">
            <div className="space-y-4 sm:space-y-6 lg:space-y-8 text-center sm:text-right">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 pt-4 justify-end">
                <a href="#works" className="text-center py-3.5 sm:py-3 text-sm px-6 sm:px-8 inline-block bg-white text-stone-900 border border-white hover:bg-stone-900 hover:text-white transition-colors duration-300">
                  SELECTED WORKS
                </a>
