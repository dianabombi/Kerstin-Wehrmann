...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-right">
            ...
            <p className="text-lg md:text-xl font-sans font-light text-stone-700 tracking-luxury italic">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 pt-4 justify-center lg:justify-end">
